package demo_chanhtran.demo_manager_student.IO_1.util;

import demo_chanhtran.demo_manager_student.IO_1.model.Student;
...
public class ReadAndWriteFile {
    final static String STUDENT_PATH ="src/demo_chanhtran/demo_manager_student/data/student.csv";
